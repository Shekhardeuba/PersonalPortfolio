...
const ProjectsCards = () => {
  const handle = () => {
    ...
    const handleNetflix = () => {
    // Define the URL you want to navigate to
    const link = "https://netflix-xi-steel-64.vercel.app/"; 
    ...
    <div className="w-full h-full p-8 bg-gray-900 rounded-lg overflow-hidden flex justify-between items-center ">
      <div className="flex flex-col justify-between items-center rounded-lg p-2 bg-black">
        ...
        <div className="flex flex-col justify-start items-center space-y-16 mb-5">
          ...
          <div className="w-72 text-center text-gray-500 text-base font-normal leading-7 font-sans">
          A React-powered Car App featuring flash cards with dynamic car details, FlatList scrolling, and intuitive navigation for seamless exploration.
The app leverages responsive design to ensure a consistent experience across devices.   
          </div>
        </div>
      </div>
    </div>
    <div className="w-full h-full p-8 bg-gray-900 rounded-lg overflow-hidden flex flex-col justify-start items-start space-y-8">
      <div className="flex flex-col justify-start items-center rounded-md p-2 bg-black">
        ...
        <div className="flex flex-col justify-start items-center space-y-16 mb-5">
          ...
          <div className="w-72 text-center text-gray-500 text-base font-normal leading-7 font-sans">
"Netflix Clone: Redux for state management, seamlessly integrates APIs, and incorporates web views, supported by a RESTful Node.js backend for a feature-rich shopping experience."     <br/>
 <button className='text-white' onClick={handleNetflix}>  Link </button>     </div>
        </div>
      </div>
    </div>
    </div>
